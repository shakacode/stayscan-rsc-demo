...
-- top_rated mirrors ListingScore#top_rated? exactly (highly rated AND reviewed AND
-- trusted [verified owner OR book-direct]) so the browse filter matches the tile badge.
